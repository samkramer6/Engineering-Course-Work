...
%
%   This is a highly situationally dependent function that is used for the
%   2023 IRES program to visualize the data after a test has been
%   completed. This function can test all the microphones to see if they are
%   working or not and can be used to check data from microphones as well.
%
